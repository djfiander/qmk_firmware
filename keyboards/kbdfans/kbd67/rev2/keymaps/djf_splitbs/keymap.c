...
[_FL] = LAYOUT_65_ansi_split_bs(
  ...
  KC_CAPS,          _______, _______, _______, _______, RESET, _______,   _______, _______, _______, _______,          KC_BTN1, KC_MS_U, KC_BTN2, \
  _______, MO(_PL), _______,                   _______,                            _______, MO(_PL),         _______,  KC_MS_L, KC_MS_D, KC_MS_R),

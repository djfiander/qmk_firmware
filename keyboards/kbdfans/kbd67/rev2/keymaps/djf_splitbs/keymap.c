...
[_BL] = LAYOUT_65_ansi_split_bs(
  ...
  MO(_FL), KC_LGUI,   KC_LALT,                   KC_SPC,                                  KC_RALT,   KC_RGUI, MEH_APP, KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FL] = LAYOUT_65_ansi_split_bs(
  ...
  _______,          _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,   _______,          _______, _______,
  _______, MO(_RL), _______,                   _______,                            _______, MO(_RL),        _______,   _______, _______, _______),

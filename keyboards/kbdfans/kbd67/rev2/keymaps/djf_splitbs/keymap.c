...
[_FL] = LAYOUT_65_ansi_split_bs(
  ...
  KC_CAPS,          _______, _______, _______, _______, RESET, _______,   _______, _______, _______, _______,          _______, _______, _______, \
  _______, MO(_PL), _______,                   _______,                            _______, MO(_PL),         _______,  _______, _______, _______),

...
[_BL] = LAYOUT_65_ansi_split_bs(
  ...
  MO(_FL), KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, KC_RGUI,  KC_APP,          KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FL] = LAYOUT_65_ansi_split_bs(
  ...
  _______,          _______, _______, _______, _______, RESET, _______,   _______, _______, _______, _______,          KC_BTN1, KC_MS_U, KC_BTN2, \
  _______, MO(_PL), _______,                   _______,                            _______, _______,         _______,  KC_MS_L, KC_MS_D, KC_MS_R),
